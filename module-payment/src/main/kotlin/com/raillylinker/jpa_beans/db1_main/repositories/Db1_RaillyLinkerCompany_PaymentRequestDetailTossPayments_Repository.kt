...
@Repository
interface Db1_RaillyLinkerCompany_PaymentRequestDetailTossPayments_Repository :
    JpaRepository<Db1_RaillyLinkerCompany_PaymentRequestDetailTossPayments, Long> {
}
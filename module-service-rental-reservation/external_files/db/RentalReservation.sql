CREATE TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_INFO` (
	...
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID`	BIGINT UNSIGNED	NULL	COMMENT 'HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT 행 고유키(결재되지 않았다면 null)',
...
ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_INFO` ADD CONSTRAINT `FK_HCP_PAYMENT_TO_HCP_RENTABLE_PRODUCT_RESERVATION_INFO_1` FOREIGN KEY (

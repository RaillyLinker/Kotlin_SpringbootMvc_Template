...
CREATE TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_STATE_CHANGE_INFO` (
	...
	`STATE_CODE`	TINYINT UNSIGNED	NOT NULL	COMMENT '예약 상태 코드(1 : 예약 신청, 2 : 결재 완료, 3 : 예약 승인, 4 : 예약 거부, 5 : 예약 취소 신청, 6 : 예약 취소 승인, 7 : 예약 취소 거부, 8 : 예약 취소 후 환불 완료, 9: 조기반납신고, 10:조기반납 확인,11:조기반납 신고취소)',
...
CREATE TABLE `HCP_PAYMENT` (
	...
	`PAYMENT_CURRENCY_CODE`	CHAR(3)	NOT NULL	COMMENT '결재 금액 통화 코드(IOS 4217, ex : KRW, USD, EUR...)',

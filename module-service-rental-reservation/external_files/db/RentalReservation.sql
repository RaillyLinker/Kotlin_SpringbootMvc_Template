...
CREATE TABLE `HCP_PAYMENT` (
	...
	`PAYMENT_AMOUNT`	DECIMAL(15, 2) UNSIGNED	NOT NULL	COMMENT '결재 금액',
...
ALTER TABLE `HCP_PAYMENT_REAL_TIME_TRANSFERS` ADD CONSTRAINT `FK_HCP_PAYMENT_TO_HCP_PAYMENT_REAL_TIME_TRANSFERS_1` FOREIGN KEY (
	`HCP_HCP_PAYMENT_UID`
)
REFERENCES `HCP_PAYMENT` (
	`HCP_HCP_PAYMENT_UID`
);

ALTER TABLE `HCP_PAYMENT_VIRTUAL_ACCOUNT_PAY` ADD CONSTRAINT `FK_HCP_PAYMENT_TO_HCP_PAYMENT_VIRTUAL_ACCOUNT_PAY_1` FOREIGN KEY (
	`HCP_HCP_PAYMENT_UID`
)
REFERENCES `HCP_PAYMENT` (
	`HCP_HCP_PAYMENT_UID`
...
ALTER TABLE `HCP_PAYMENT_TOSS_PAYMENT` ADD CONSTRAINT `FK_HCP_PAYMENT_TO_HCP_PAYMENT_TOSS_PAYMENT_1` FOREIGN KEY (
	`HCP_HCP_PAYMENT_UID`
)
REFERENCES `HCP_PAYMENT` (
	`HCP_HCP_PAYMENT_UID`
...
ALTER TABLE `HCP_PAYMENT_REFUND` ADD CONSTRAINT `FK_HCP_PAYMENT_TO_HCP_PAYMENT_REFUND_1` FOREIGN KEY (
	`HCP_HCP_PAYMENT_UID`
)
REFERENCES `HCP_PAYMENT` (
	`HCP_HCP_PAYMENT_UID`
...
ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_INFO` ADD CONSTRAINT `FK_HCP_RENTABLE_PRODUCT_RESERVATION_INFO_TO_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_INFO_1` FOREIGN KEY (
	`HCP_PRODUCT_RESERVATION_INFO_UID`
)
REFERENCES `HCP_RENTABLE_PRODUCT_RESERVATION_INFO` (
	`HCP_PRODUCT_RESERVATION_INFO_UID`
...
ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_INFO` ADD CONSTRAINT `FK_HCP_PAYMENT_TO_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_INFO_1` FOREIGN KEY (
	`HCP_HCP_PAYMENT_UID`
)
REFERENCES `HCP_PAYMENT` (
	`HCP_HCP_PAYMENT_UID`

...
CREATE TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT` (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_PRODUCT_RESERVATION_INFO_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT 'HCP_RENTABLE_PRODUCT_RESERVATION_INFO 행 고유키',
	`PAYMENT_TYPE`	TINYINT UNSIGNED	NOT NULL	COMMENT '결재 타입(1 : 무통장 입금, 2 : 실시간 계좌이체, 3 : 토스 페이)',
	`PAYMENT_AMOUNT`	BIGINT UNSIGNED	NOT NULL	COMMENT '결재 금액',
	`PAYMENT_COMPLETE_DATETIME`	DATETIME(3)	NULL	COMMENT '결재가 완료 및 확인 된 일시(Null 이라면 아직 완료 처리가 아님)',
	`PAYMENT_FAILED`	BIT(1)	NOT NULL	COMMENT '결재 실패 여부'
);

CREATE TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_REAL_TIME_TRANSFERS` (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_REAL_TIME_TRANSFERS_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID2`	BIGINT UNSIGNED	NOT NULL	COMMENT '행 고유키',
...
CREATE TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_VIRTUAL_ACCOUNT_PAY` (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_VIRTUAL_ACCOUNT_PAY_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID2`	BIGINT UNSIGNED	NOT NULL	COMMENT '행 고유키',
	`BANK_NAME`	VARCHAR(100)	NOT NULL	COMMENT '입금 은행명',
...
CREATE TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_TOSS_PAYMENT` (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_VIRTUAL_ACCOUNT_PAY_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID2`	BIGINT UNSIGNED	NOT NULL	COMMENT '행 고유키',
...
ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT` ADD CONSTRAINT `PK_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT` PRIMARY KEY (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID`
);

ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_REAL_TIME_TRANSFERS` ADD CONSTRAINT `PK_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_REAL_TIME_TRANSFERS` PRIMARY KEY (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_REAL_TIME_TRANSFERS_UID`
);

ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_VIRTUAL_ACCOUNT_PAY` ADD CONSTRAINT `PK_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_VIRTUAL_ACCOUNT_PAY` PRIMARY KEY (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_VIRTUAL_ACCOUNT_PAY_UID`
);

ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_TOSS_PAYMENT` ADD CONSTRAINT `PK_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_TOSS_PAYMENT` PRIMARY KEY (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_VIRTUAL_ACCOUNT_PAY_UID`
);
...
ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT` ADD CONSTRAINT `FK_HCP_RENTABLE_PRODUCT_RESERVATION_INFO_TO_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_1` FOREIGN KEY (
	`HCP_PRODUCT_RESERVATION_INFO_UID`
)
REFERENCES `HCP_RENTABLE_PRODUCT_RESERVATION_INFO` (
	`HCP_PRODUCT_RESERVATION_INFO_UID`
...
ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_REAL_TIME_TRANSFERS` ADD CONSTRAINT `FK_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_TO_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_REAL_TIME_TRANSFERS_1` FOREIGN KEY (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID2`
)
REFERENCES `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT` (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID`
);

ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_VIRTUAL_ACCOUNT_PAY` ADD CONSTRAINT `FK_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_TO_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_VIRTUAL_ACCOUNT_PAY_1` FOREIGN KEY (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID2`
)
REFERENCES `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT` (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID`
...
ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_TOSS_PAYMENT` ADD CONSTRAINT `FK_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_TO_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_TOSS_PAYMENT_1` FOREIGN KEY (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID2`
)
REFERENCES `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT` (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_UID`

CREATE TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_INFO` (
	`HCP_RENTABLE_PRODUCT_RESERVATION_INFO_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
...
CREATE TABLE `HCP_RENTABLE_PRODUCT_STOCK_INFO` (
	`HCP_RENTABLE_PRODUCT_STOCK_INFO_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_RENTABLE_PRODUCT_STOCK_CATEGORY_UID`	BIGINT UNSIGNED	NULL	COMMENT 'HCP_RENTABLE_PRODUCT_STOCK_CATEGORY 행 고유키',
	`HCP_RENTABLE_PRODUCT_STOCK_IMAGE_UID`	BIGINT UNSIGNED	NULL	COMMENT 'HCP_RENTABLE_PRODUCT_STOCK_IMAGE 행 고유키',
...
CREATE TABLE `HCP_RENTABLE_PRODUCT_INFO` (
	`HCP_RENTABLE_PRODUCT_INFO_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
...
CREATE TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_STATE_CHANGE_HISTORY` (
	`HCP_RENTABLE_PRODUCT_RESERVATION_STATE_CHANGE_HISTORY_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_PRODUCT_RESERVATION_INFO_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT 'HCP_RENTABLE_PRODUCT_RESERVATION_INFO 행 고유키',
	`STATE_CODE`	TINYINT UNSIGNED	NOT NULL	COMMENT '예약 상태 코드(0 : 관리자 결제 확인, 1 : 관리자 예약 승인, 2 : 관리자 예약 거부, 3 : 사용자 예약 취소 신청, 4 : 관리자 예약 취소 승인, 5 : 관리자 예약 취소 거부, 6: 관리자 결제 환불 처리)',
	`STATE_CHANGE_DESC`	VARCHAR(600)	NOT NULL	COMMENT '상태 변경 상세'
);

CREATE TABLE `HCP_RENTABLE_PRODUCT_STOCK_RESERVATION_INFO` (
	`HCP_RENTABLE_PRODUCT_STOCK_RESERVATION_INFO_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_RENTABLE_PRODUCT_STOCK_INFO_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT 'HCP_RENTABLE_PRODUCT_STOCK_INFO 행 고유키',
	`HCP_RENTABLE_PRODUCT_RESERVATION_INFO_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT 'HCP_RENTABLE_PRODUCT_RESERVATION_INFO 행 고유키',
	`PRODUCT_READY_DATETIME`	DATETIME	NULL	COMMENT '개별 상품이 대여 반납 이후 준비가 완료된 시간(미리 설정도 가능, 히스토리 테이블 내역보다 우선됩니다.)'
);

CREATE TABLE `HCP_RENTABLE_PRODUCT_CATEGORY` (
	`HCP_RENTABLE_PRODUCT_CATEGORY_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
...
CREATE TABLE `HCP_RENTABLE_PRODUCT_IMAGE` (
	`HCP_RENTABLE_PRODUCT_IMAGE_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_RENTABLE_PRODUCT_INFO_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT 'HCP_RENTABLE_PRODUCT_INFO 행 고유키',
...
CREATE TABLE `HCP_RENTABLE_PRODUCT_STOCK_CATEGORY` (
	`HCP_RENTABLE_PRODUCT_STOCK_CATEGORY_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`PARENT_CATEGORY_UID`	BIGINT UNSIGNED	NULL	COMMENT '부모 카테고리의 고유키',
	`CATEGORY_NAME`	VARCHAR(90)	NOT NULL	COMMENT '카테고리 이름'
);

CREATE TABLE `HCP_RENTABLE_PRODUCT_STOCK_IMAGE` (
	`HCP_RENTABLE_PRODUCT_STOCK_IMAGE_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_RENTABLE_PRODUCT_STOCK_INFO_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT 'HCP_RENTABLE_PRODUCT_STOCK_INFO 행 고유키',
	`IMAGE_FULL_URL`	VARCHAR(200)	NOT NULL	COMMENT '상품 이미지 Full URL'
...
CREATE TABLE `HCP_PAYMENT` (
	`HCP_PAYMENT_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
...
CREATE TABLE `HCP_PAYMENT_REAL_TIME_TRANSFERS` (
	`HCP_PAYMENT_REAL_TIME_TRANSFERS_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_PAYMENT_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT '행 고유키',
...
CREATE TABLE `HCP_PAYMENT_VIRTUAL_ACCOUNT_PAY` (
	`HCP_PAYMENT_VIRTUAL_ACCOUNT_PAY_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_PAYMENT_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT '행 고유키',
	`BANK_NAME`	VARCHAR(100)	NOT NULL	COMMENT '입금 은행명',
...
CREATE TABLE `HCP_PAYMENT_TOSS_PAYMENT` (
	`HCP_PAYMENT_TOSS_PAYMENT_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_PAYMENT_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT '행 고유키',
...
CREATE TABLE `HCP_PAYMENT_REFUND` (
	`HCP_PAYMENT_REFUND_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_PAYMENT_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT 'HCP_PAYMENT 행 고유키',
...
CREATE TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_INFO` (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_INFO_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_RENTABLE_PRODUCT_RESERVATION_INFO_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT 'HCP_RENTABLE_PRODUCT_RESERVATION_INFO 행 고유키',
	`HCP_PAYMENT_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT 'HCP_PAYMENT 행 고유키'
...
CREATE TABLE `HCP_RENTABLE_PRODUCT_STOCK_RESERVATION_STATE_CHANGE_HISTORY` (
	`HCP_RENTABLE_PRODUCT_STOCK_RESERVATION_STATE_CHANGE_HISTORY_UID`	BIGINT	NOT NULL	COMMENT '행 고유키',
	`DEL_FRAG`	BIT(1)	NOT NULL	COMMENT '행 삭제여부',
	`ROW_CREATE_DATETIME`	DATETIME(3)	NOT NULL	COMMENT '행 생성일시',
	`HCP_RENTABLE_PRODUCT_STOCK_RESERVATION_INFO_UID`	BIGINT UNSIGNED	NOT NULL	COMMENT '행 고유키',
	`STATE_CODE`	TINYINT UNSIGNED	NOT NULL	COMMENT '예약 상태 코드(0 : 사용자 조기 반납 신고, 1 : 관리자 반납 확인, 2 : 관리자 연체 상태 변경, 3 : 관리자 손망실 상태 변경, 4: 관리자 반납 확인 취소, 5 : 관리자 연체 상태 변경 취소, 6 : 관리자 손망실 상태 변경 취소, 7 : 사용자 조기 반납 신고 취소)',
	`STATE_CHANGE_DESC`	VARCHAR(600)	NOT NULL	COMMENT '상태 변경 상세'
);

ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_INFO` ADD CONSTRAINT `PK_HCP_RENTABLE_PRODUCT_RESERVATION_INFO` PRIMARY KEY (
	`HCP_RENTABLE_PRODUCT_RESERVATION_INFO_UID`
);
...
ALTER TABLE `HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_INFO` ADD CONSTRAINT `PK_HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_INFO` PRIMARY KEY (
	`HCP_RENTABLE_PRODUCT_RESERVATION_PAYMENT_INFO_UID`
);

ALTER TABLE `HCP_RENTABLE_PRODUCT_STOCK_RESERVATION_STATE_CHANGE_HISTORY` ADD CONSTRAINT `PK_HCP_RENTABLE_PRODUCT_STOCK_RESERVATION_STATE_CHANGE_HISTORY` PRIMARY KEY (
	`HCP_RENTABLE_PRODUCT_STOCK_RESERVATION_STATE_CHANGE_HISTORY_UID`
);

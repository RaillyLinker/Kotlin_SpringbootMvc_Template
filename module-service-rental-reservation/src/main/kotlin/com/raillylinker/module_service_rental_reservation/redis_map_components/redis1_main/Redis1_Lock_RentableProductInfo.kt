...
import com.raillylinker.module_service_rental_reservation.abstract_classes.BasicRedisLock
...
// [RedisMap 컴포넌트]
@Component
class Redis1_Lock_RentableProductInfo(
    // !!!RedisConfig 종류 변경!!!
    ...
    companion object {
        ...
        const val MAP_NAME = "Redis1_Lock_RentableProductInfo"
    }
}
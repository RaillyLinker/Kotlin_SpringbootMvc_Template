package com.raillylinker.module_sample_socket.services.impls

import com.raillylinker.module_sample_socket.controllers.WebSocketStompController
import com.raillylinker.module_sample_socket.services.WebSocketStompService
...
class WebSocketStompServiceImpl(
    ...
    // ---------------------------------------------------------------------------------------------
    // <공개 메소드 공간>
    override fun sendToTopicTest(inputVo: WebSocketStompController.SendToTopicTestInputVo): WebSocketStompController.TopicVo {

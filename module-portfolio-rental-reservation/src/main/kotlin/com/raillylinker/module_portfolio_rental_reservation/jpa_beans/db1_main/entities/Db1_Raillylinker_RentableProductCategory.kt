...
class Db1_Raillylinker_RentableProductCategory(
    ...
    var parentRentableProductCategory: Db1_Raillylinker_RentableProductCategory?
) {
    @Id
    ...
    var childRentableProductCategoryList: MutableList<Db1_Raillylinker_RentableProductCategory> = mutableListOf()

    @OneToMany(
        mappedBy = "rentableProductCategory",
        fetch = FetchType.LAZY
    )
    var rentableProductInfoList: MutableList<Db1_Raillylinker_RentableProductInfo> = mutableListOf()
}
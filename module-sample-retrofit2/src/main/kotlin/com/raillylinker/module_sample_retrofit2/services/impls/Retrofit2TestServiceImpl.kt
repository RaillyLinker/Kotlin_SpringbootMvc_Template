package com.raillylinker.module_sample_retrofit2.services.impls
...
import com.raillylinker.module_sample_retrofit2.retrofit2_classes.RepositoryNetworkRetrofit2
import com.raillylinker.module_sample_retrofit2.retrofit2_classes.request_apis.LocalHostRequestApi
...
@Service
class Retrofit2TestServiceImpl(
    // (프로젝트 실행시 사용 설정한 프로필명 (ex : dev8080, prod80, local8080, 설정 안하면 default 반환))
    @Value("\${spring.profiles.active:default}") private var activeProfile: String
) : Retrofit2TestService {
    // <멤버 변수 공간>
    ...
    ////
    override fun redirectTest(httpServletResponse: HttpServletResponse): String? {
        try {
            // 네트워크 요청
            val responseObj =
    ...
    ////
    override fun forwardTest(httpServletResponse: HttpServletResponse): String? {
        try {
            // 네트워크 요청
            val responseObj =
    ...
    ////
    override fun getRequestTest(httpServletResponse: HttpServletResponse): Retrofit2TestController.GetRequestTestOutputVo? {
        try {
            // 네트워크 요청
    ...
    ////
    override fun getRequestTestWithPathParam(httpServletResponse: HttpServletResponse): Retrofit2TestController.GetRequestTestWithPathParamOutputVo? {
        try {
            // 네트워크 요청
            val responseObj =
    ...
    ////
    override fun postRequestTestWithApplicationJsonTypeRequestBody(httpServletResponse: HttpServletResponse): Retrofit2TestController.PostRequestTestWithApplicationJsonTypeRequestBodyOutputVo? {
        try {
            // 네트워크 요청
            val responseObj =
    ...
    ////
    override fun postRequestTestWithFormTypeRequestBody(httpServletResponse: HttpServletResponse): Retrofit2TestController.PostRequestTestWithFormTypeRequestBodyOutputVo? {
        try {
            // 네트워크 요청
            val responseObj =
    ...
    ////
    override fun postRequestTestWithMultipartFormTypeRequestBody(httpServletResponse: HttpServletResponse): Retrofit2TestController.PostRequestTestWithMultipartFormTypeRequestBodyOutputVo? {
        try {
            // 네트워크 요청
    ...
    ////
    override fun postRequestTestWithMultipartFormTypeRequestBody2(httpServletResponse: HttpServletResponse): Retrofit2TestController.PostRequestTestWithMultipartFormTypeRequestBody2OutputVo? {
        try {
            // 네트워크 요청
            val requestFormString = MultipartBody.Part.createFormData("requestFormString", "paramFromServer")
            val requestFormInt = MultipartBody.Part.createFormData("requestFormInt", 1.toString())
    ...
    ////
    override fun postRequestTestWithMultipartFormTypeRequestBody3(httpServletResponse: HttpServletResponse): Retrofit2TestController.PostRequestTestWithMultipartFormTypeRequestBody3OutputVo? {
        try {
            // 네트워크 요청
    ...
    ////
    override fun returnResultCodeThroughHeaders(httpServletResponse: HttpServletResponse) {
        try {
            // 네트워크 요청
    ...
    ////
    override fun returnTextHtmlTest(httpServletResponse: HttpServletResponse): String? {
        try {
            // 네트워크 요청
            val responseObj =
    ...
    ////
    override fun asynchronousResponseTest(httpServletResponse: HttpServletResponse): Retrofit2TestController.AsynchronousResponseTestOutputVo? {
        try {
            // 네트워크 요청
            val responseObj =
    ...
    // todo
    ////
//    override fun sseSubscribeTest(httpServletResponse: HttpServletResponse) {
...
//    }
    ...
    ////
    override fun websocketConnectTest(httpServletResponse: HttpServletResponse) {
